...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-offset-2 dark:hover:bg-zinc-800 dark:hover:text-zinc-100 disabled:opacity-50 dark:focus:ring-zinc-400 disabled:pointer-events-none dark:focus:ring-offset-zinc-900 data-[state=open]:bg-zinc-100 dark:data-[state=open]:bg-zinc-800",
  {
    variants: {
      variant: {
        // default:
        //   "bg-zinc-900 text-white hover:bg-zinc-700 dark:bg-zinc-300 dark:text-zinc-900 dark:hover:bg-zinc-200 shadow-md shadow-black",
        default:
          "bg-zinc-900 text-white hover:bg-zinc-700 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-900 shadow-md shadow-black border-2 border-zinc-600 rounded-md",
        destructive:
          "bg-red-500 text-white hover:bg-red-600 dark:hover:bg-red-600 shadow-md shadow-black",
        outline:
