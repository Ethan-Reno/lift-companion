      ...
      <DialogPrimitive.Portal forceMount>
        <Transition.Root show={isOpen}>
          ...
          >
            ...
            >
              {title && 
                <DialogPrimitive.Title className="text-m font-bold text-neutral-900 dark:text-neutral-100">
                  {title}
                </DialogPrimitive.Title>
              }
              {description &&
                <DialogPrimitive.Description className="mt-2 text-m text-neutral-700 dark:text-neutral-400">
                  {description}
